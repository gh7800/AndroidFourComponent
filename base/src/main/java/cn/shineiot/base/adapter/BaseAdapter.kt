...
open class BaseAdapter<T> : RecyclerView.Adapter<RecyclerView.ViewHolder> {
     ...
     * 追加单个元素
     */
    fun addElement(index: Int = mList.size, t: T) {
        mList.add(index, t)
        notifyDataSetChanged()
    }
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (holder is KtViewHolder) {
            val viewHolder = holder as KtViewHolder
            ...
            viewHolder.itemView.setOnClickListener {
                itemClick?.OnItemClick(viewHolder.itemView, viewHolder.adapterPosition)
            }

            viewHolder.itemView.setOnLongClickListener {
                itemLongClick?.OnItemLongClick(viewHolder.itemView, viewHolder.adapterPosition)
                false
            }

            convert(viewHolder.itemView, item, viewHolder.adapterPosition)
